...
class documentReminder extends Notification implements ShouldQueue
{
    ...
    public function toBroadcast($notifiable)
    {
        return new BroadcastMessage([
            'message' => 'Please submit your document.',
    ...
    public function broadcastOn()
    {
        ...
        \Log::info('Broadcasting to channel: documentReminder.' . $this->broadcastNotifable->id);
        
        // Broadcast on a private channel based on the user's ID
        return [new PrivateChannel('documentReminder.' . $this->broadcastNotifable->id)];
    }
