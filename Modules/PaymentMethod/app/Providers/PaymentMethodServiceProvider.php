...
use Modules\PaymentMethod\Repositories\UserPaymentMethodRepository;

class PaymentMethodServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'PaymentMethod';

    protected string $moduleNameLower = 'paymentmethod';
    ...
    public function boot(): void
    {
        ...
        Cashier::useCustomerModel(PaymentUser::class);
    }
